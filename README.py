...
# 
# Para configurar/instalar/usar para não perguntar sobre atualizar o , você pode seguir estas etapas:
# 
# 1. Abra o `Whisker Menu` pressionando a tecla a seguir ou clicando no ícone Iniciar: `Super (Win)`
# 
# 2. Digite o seguinte comando: `Software & Updates`
# 
# 3. Clique na botão: `Software & Updates`
# 
# 4. Clique na aba: `Updates`
# 
# 5. Em `Notify me of a new Ubuntu version` selecione a opção: `Never`.

# ### 1.1 Codigo completo para configurar/instalar/usar
# 
# Para configurar/instalar/usar o `NÃO atualizar o kernel` no `Linux Ubuntu` sem precisar digitar linha por linha, você pode seguir estas etapas:
# 
